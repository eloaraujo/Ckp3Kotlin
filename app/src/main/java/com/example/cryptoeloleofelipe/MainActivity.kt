package com.example.cryptoeloleofelipe
...
import com.example.cryptoeloleofelipe.service.MercadoBitcoinServiceFactory
            ...
            CoroutineScope(Dispatchers.Main).launch {
                try {
                    ...
                    if (response.isSuccessful) {
                        ...
                        lblDate.text = date?.let { sdf.format(it) } ?: "Data não disponível"
